...
#Se muestra en pantalla el número decimal convertido a hexadecimal.
    print(f" y 0x{hexa} en hexadecimal", end=" ")
    print()
...
#Se implementa la lógica necesaria para convertir el número binario a decimal.
    print(f"El número binario 0b{numero_binario}", end=" ")
...
#Se muestra en pantalla la conversión a número decimal
    print(F"El número hexadecimal 0x{numero_hexadecimal} es  {numero_decimal} en decimal",end=" ")
...
def suma_binario():
    ...
    i = 0
    # Se solicita un número en base binario.
    numero_binario = int(input("Ingrese primer número en base binario: "))
    z=numero_binario
    # Se implementa la lógica necesaria para convertir el número binario a decimal.
    while (numero_binario >= 1):
        d = numero_binario % 10
    ...
    y = 0
    # Se solicita un número en base binario.
    numero_binario2 = int(input("Ingrese segundo número en base binario: "))
    print(f"La suma del numero binario 0b{z} y el numero binario 0b{numero_binario2} ", end=" ")
    # Se implementa la lógica necesaria para convertir el número binario a decimal.
    while (numero_binario2 >= 1):
        l = numero_binario2 % 10
        numero_binario2 = numero_binario2 // 10
        x = x + l * pow(2, y)  # Hasta este punto (s) tiene el numero en base decimal
        y += 1
    binario_2=x
    decimal = binario_1+binario_2
    d = []
    # Se realiza la implementación de la lógica para convertir el número decimal a binario.
    while (decimal >= 1):
        d.append(decimal % 2)
