...
alumnos={'nombre':"Addi",
         'materias':{'Electronica':0,'Algebra':0,'Estructura de datos':0,'Derecho y legislacion':0,'Contabilidad':0,'Ingles':0}}
...
def ingresar_alumno(alumnos):
    ...
    while numero is None:
        ...
        numero = cadena_a_flotante(electronica)
    alumnos['materias']["Electronica"] = electronica
    ...
    while numero is None:
        ...
        numero = cadena_a_flotante(algebra)
    alumnos['materias']["Algebra"] = algebra
    ...
    while numero is None:
        ...
        numero = cadena_a_flotante(estructura)
    alumnos['materias']["Estructura de datos"] =  estructura
    ...
    while numero is None:
        ...
        numero = cadena_a_flotante(derecho)
    alumnos['materias']["Derecho y legislacion"] = derecho
    ...
    while numero is None:
        ...
        numero = cadena_a_flotante(contabilidad)
    alumnos['materias']["Contabilidad"] = contabilidad

    ingles= input("Ingrese calificación de la materia de Ingles: ")
    numero = cadena_a_flotante(ingles)
    while numero is None:
        ingles = input("Acción inválida, ingrese nuevamente la calificación de la materia de Ingles: ")
        numero = cadena_a_flotante(ingles)
    alumnos['materias']["Ingles"] = ingles

def promedio(alumnos)->None:
    suma=0
    materias=len(alumnos['materias'])
    for alumno in alumnos['materias'].values():
        suma+=alumno
    print()
