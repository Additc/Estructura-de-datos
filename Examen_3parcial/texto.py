...
# Ejemplo de uso
    ...
    mensaje5=("=================================================================\n"
                ...
                "===============================================================\n")
    mensaje6=("| | | | | | | | | | | | | | | | | | | | | | | | | | | | | ")
    animacion_texto(mensaje,0.01, Fore.RED)
    animacion_texto(mensaje1, 0.01, Fore.LIGHTYELLOW_EX)
    animacion_texto(mensaje2, 0.01, Fore.MAGENTA)
    animacion_texto(mensaje3, 0.01, Fore.BLUE)
    animacion_texto(mensaje4, 0.01, Fore.GREEN)
    animacion_texto(mensaje5, 0.01, Fore.CYAN)
    animacion_texto(mensaje6, 0.01, Fore.WHITE)
